                ...
                <div class="section group">
                    ...
                    <div class="col span_1_of_5">
                        ...
                        <telerik:RadGrid runat="server" AllowPaging="false" ID="RadGridDisplay" CommandItemStyle-Visible="false"
                            ...
                            ShowFooter="false" AllowSorting="true" Width="60%">
                            <MasterTableView DataKeyNames="AddcartID" EditMode="EditForms" AutoGenerateColumns="false"
                                ...
                                <Columns>
                                  ...
                                  <%--  <telerik:GridBoundColumn DataField="ReturnDate" HeaderText="Return Date" SortExpression="ReturnDate"
                                        UniqueName="ReturnDate" DataFormatString="{0:dd/MMM/yyyy}">
                                        <HeaderStyle Width="3%" HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="ReturnReason" DataType="System.String" HeaderText="Return Reason"
                                        SortExpression="ReturnReason" UniqueName="ReturnReason" Visible="true">
                                        <ItemStyle HorizontalAlign="Left" />
                                    </telerik:GridBoundColumn>--%>
                        ...
                        <div class="contact-form1">
                            <div>
                                <span>
                                    ...
                                    <telerik:RadComboBox ID="cboReason" runat="server" Height="140px" Width="250px" DataValueField="Dept_ID"
                                        ...
                                        AutoPostBack="false" Visible="true">
                                        <Items>
                                            <telerik:RadComboBoxItem Text="Wrong item delivered" Value="0" />
                                            <telerik:RadComboBoxItem Text="Delivery-Missing Parts" Value="1" />
                                            <telerik:RadComboBoxItem Text="Change of mind" Value="2" />
                                            <telerik:RadComboBoxItem Text="Damaged" Value="3" />
                                            <telerik:RadComboBoxItem Text="Not as expected" Value="4" />
                                            <telerik:RadComboBoxItem Text="Defective" Value="5" />
                                            <telerik:RadComboBoxItem Text="Does not fit" Value="6" />
                                            <telerik:RadComboBoxItem Text="Quality-product condition" Value="7" />
                                            <telerik:RadComboBoxItem Text="Website-incorrect content" Value="8" />
                                        </Items>
                                    </telerik:RadComboBox>
                                </span>
                            </div>
                            <div>
                                <span>
                                    <label>
                                        How would you like to be reimburse?
                                    </label>
                            ...
                            <div>
                                <span>&nbsp;&nbsp;
                                    <asp:Button ID="btnReturnOrder" runat="server" Text="Submit" CssClass="enjoy-css"
                                        Visible="true" OnClick="btnReturnOrder_Click" /></span>
                            </div>
                        </div>
                    </div>
                </div>
