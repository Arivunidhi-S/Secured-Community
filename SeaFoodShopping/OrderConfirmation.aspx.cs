...
public partial class OrderConfirmation : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (status.ToString() == "success")
            {
                ...
                if (update >= 1)
                {
                    ...
                    msg = "<font face='Cambria Math'>Dear " + Name.ToString() + ",<br><br>" + "Your Order No # <b>" + lblOrderno.Text.ToString() + "</b> has been placed on <b>" + String.Format("{0:dddd, MMMM dd, yyyy hh:mm}", DateTime.Now) + "</b> via Credit or Debit Card. <br><br> *Please take note delivery will be made within 30 minutes to 2 Hours.*<br><br>Your Order will be delivered to below address:<br><br><b>" + Name.ToString() + " <br>" + Address1.ToString() + " &nbsp;" + Address2.ToString() + " <br>" + PostCode.ToString() + " &nbsp;" + City.ToString() + " <br>" + State.ToString() + "  &nbsp;" + Country.ToString() + "</b>";
                    ...
                    BusinessTier.SendMail(Email.ToString(), "Fish Market Order Confirmation", msg);
                }
            }
            else 
            {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            //@Param = "31";
            @Param = Request.QueryString.Get("param1").ToString();
            string sql1 = "select count(*) as Cart, sum(DiscountPrice*Qnty) as Total, sum(ShippingCost*Qnty) as ShipCost from Vw_AddCart where DELETED=0 and PayMethod='Online Banking/Credit Card' and ShippingID='" + @Param.ToString() + "'";
    ...
    public DataTable DataSourceHelper()
    {
        ...
        string sql = "select * FROM Vw_AddCart WHERE shippingid='" + @Param.ToString() + "' and Deleted=0  and PayMethod='Online Banking/Credit Card' and Customerid='" + CustomerID.ToString() + "' ";  // and CREATED_DATE='" + today.ToString() + "'
